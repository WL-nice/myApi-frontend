...
import {deleteUserInterfaceInfo, listUserInterfaceInfoByPage} from "@/services/myapi/userInterfaceInfoController";
...
const InterfaceInfoAdminPage: React.FC = () => {
  ...
  const handleDelete = async (row: API.User) => {
    ...
    if (!row) return true;
    try {
      await deleteUserInterfaceInfo({ id: row.id as any });
      hide();
